CLASS zjhn_cl_cust_entity_demo DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zjhn_cl_cust_entity_demo IMPLEMENTATION.
  METHOD if_rap_query_provider~select.
    ...
    DATA lt_userlist TYPE STANDARD TABLE OF zjs_st_bapiusname.
    DATA lt_bapiret TYPE zjs_tt_bapiret2_t.
    DATA lt_result TYPE STANDARD TABLE OF zjhn_cust_entity_demo.
    DATA ls_result TYPE zjhn_cust_entity_demo.
